...
export default function BirthdayWish() {
  ...
  return (
    // Main container
    <div className="min-h-screen bg-white flex items-center bg-slate-500 justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all bg-slate-300 [box-shadow:0px_0px_20px_black] duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">Happy 17th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-600">Tayyab Ali</CardDescription>
            <p className="text-lg text-gray-500">October 16th</p>
          </CardHeader>
